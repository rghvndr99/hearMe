      ...
      <VStack spacing={10} zIndex={1} w="full" maxW="1200px" align="stretch">
        ...
        <Stack direction={["column", "row"]} spacing={[6, 8]} className="hm-glass-card" p={[6, 8]} borderRadius="xl" align="stretch">
          <VStack align="start" spacing={3} flex="1" minW={0}>
            ...
            <Text fontSize={["sm", "md"]} color="var(--hm-color-text-secondary)">
              {t("privacy.updated", "Last Updated: October 2025")}
            </Text>
            <Text fontSize={["md", "lg"]} color="var(--hm-color-text-tertiary)" lineHeight="1.8">
              {t(
                "privacy.intro",
                "Welcome to HearMe (\"we\", \"our\", or \"us\"). This Privacy Policy explains how HearMe collects, uses, stores, and protects your personal data when you use our platform, mobile app, or related services that enable emotional voice chat, voice cloning, and multilingual communication in Hindi and English."
              )}
            </Text>
          </VStack>
        </Stack>
        ...
        <Box className="hm-glass-card" p={[6, 8]} borderRadius="xl">
          ...
          <Text color="var(--hm-color-text-secondary)" mb={4}>
            {t("privacy.use.subtitle", "We use collected data solely to deliver, personalize, and enhance the HearMe experience:")}
          </Text>
          <UnorderedList spacing={2} pl={6} color="var(--hm-color-text-secondary)">
            ...
            <ListItem>
              ...
              <Link href="mailto:support@hearme.com" color="var(--hm-color-brand)">support@hearme.com</Link>
            </ListItem>
          </UnorderedList>
          <Text color="var(--hm-color-text-secondary)" mt={4}>
        ...
        <Box className="hm-glass-card" p={[6, 8]} borderRadius="xl">
          ...
          <Text color="var(--hm-color-text-secondary)" mb={3}>
            {t("privacy.sharing.intro", "We may share limited necessary data with trusted service providers who help us deliver HearMe’s features:")}
          </Text>
          <UnorderedList spacing={2} pl={6} color="var(--hm-color-text-secondary)">
        ...
        <Box className="hm-glass-card" p={[6, 8]} borderRadius="xl">
          ...
          <Text color="var(--hm-color-text-secondary)" lineHeight="1.8">
            {t("privacy.children.body", "HearMe is not intended for users under 15 years of age. We do not knowingly collect or process personal information from children below this age. If such data is found, it will be deleted immediately upon discovery.")}
          </Text>
        </Box>
        ...
        <Box className="hm-glass-card" p={[6, 8]} borderRadius="xl">
          ...
          <VStack align="start" spacing={2} color="var(--hm-color-text-secondary)">
            ...
            <Text>
              ...
              <Link href="http://www.hearme.com" isExternal color="var(--hm-color-brand)">www.hearme.com</Link>
            </Text>
          </VStack>
        </Box>
        ...
        <Box className="hm-glass-card" p={[6, 8]} borderRadius="xl">
          ...
          <Text color="var(--hm-color-text-secondary)" lineHeight="1.8">
            {t(
              ...
              "HearMe believes emotional connection should never compromise privacy. Your voice, your emotions, and your language stay yours — always protected, personal, and private."
            )}
          </Text>
        </Box>
      </VStack>
