...
export default function VoiceMate() {
  ...
  const WaveformBars = ({ active = false, width = 220, height = 32 }) => {
    ...
    useEffect(() => {
      ...
      const draw = (now) => {
        ...
        const color = getComputedStyle(document.documentElement).getPropertyValue('--vl-color-brand') || '#7c3aed';
  ...
  if (!token) {
    return (
      <Flex
        ...
        pt="100px"
        pb={[12, 20]}
        className="vl-cid-voicemate-root"
        data-cid="voicemate-root"
      >
        <VStack spacing={[12, 16, 20]} zIndex={1} maxW="1200px" w="full" px={[6, 8, 12]}>

          {/* Hero Section */}
          <VStack spacing={6} textAlign="center" maxW="900px" className="vl-cid-voicemate-hero" data-cid="voicemate-hero">
            <Heading
              as="h1"
            ...
            <Stack direction={["column", "column", "row"]} spacing={4} justify="center" w={["full", "full", "auto"]} px={[4, 6, 0]}>
              <Button
                ...
                color="white"
                _hover={{ bgGradient: 'var(--vl-gradient-cta-hover)', transform: 'translateY(-2px)' }}
          ...
          <VStack spacing={8} w="full" className="vl-cid-voicemate-use-cases" data-cid="voicemate-use-cases">
            ...
            <SimpleGrid columns={[1, 1, 3]} spacing={6} w="full" className="vl-cid-voicemate-use-cases-grid" data-cid="voicemate-use-cases-grid">
              ...
              >
                <VStack align="start" spacing={4}>
                  ...
                  <Heading size="md" color="var(--vl-color-text-primary)">
                    {t('voicemate.useCase1Title', 'Maa ki lori, chahe aap office mein ho')}
                  </Heading>
                  <Text fontSize="xs" color="var(--vl-color-text-tertiary)" fontStyle="italic">
          ...
          <VStack spacing={8} w="full" bg="var(--vl-color-bg-secondary)" p={[6, 8, 10]} borderRadius="2xl" className="vl-cid-voicemate-how-it-works" data-cid="voicemate-how-it-works">
            <Heading
              as="h2"
              fontSize={['xl', '2xl', '3xl']}
              color="var(--vl-color-text-primary)"
            ...
            <SimpleGrid columns={[1, 1, 3]} spacing={8} w="full" className="vl-cid-voicemate-how-steps" data-cid="voicemate-how-steps">
              {/* Step 1 */}
              ...
              <VStack spacing={4} textAlign="center">
                ...
                <Text fontSize="sm" color="var(--vl-color-text-secondary)">
                  {t('voicemate.step3Desc', 'Type any message in VoiceLap chat, and it speaks in YOUR voice. Send to family, friends, or use for emotional support. Your voice, your words, your connection.')}
                </Text>
              </VStack>
            </SimpleGrid>
          </VStack>
          ...
          <VStack spacing={8} w="full" className="vl-cid-voicemate-trust" data-cid="voicemate-trust">
            <Heading
              as="h2"
              fontSize={['xl', '2xl', '3xl']}
              color="var(--vl-color-text-primary)"
            ...
            <SimpleGrid columns={[1, 2, 4]} spacing={6} w="full" className="vl-cid-voicemate-trust-grid" data-cid="voicemate-trust-grid">
              <VStack spacing={3} align="start">
                <Text fontSize="2xl">🔒</Text>
                <Heading size="sm" color="var(--vl-color-text-primary)">
          ...
          {/* Benefits Section */}
          <VStack spacing={8} w="full" className="vl-cid-voicemate-benefits" data-cid="voicemate-benefits">
            <Heading
              as="h2"
              fontSize={['xl', '2xl', '3xl']}
              color="var(--vl-color-text-primary)"
            ...
            <SimpleGrid columns={[1, 2, 3]} spacing={6} w="full" className="vl-cid-voicemate-benefits-grid" data-cid="voicemate-benefits-grid">
              <Box
                className="vl-glass-card"
                p={6}
                borderRadius="xl"
              ...
              >
                <VStack align="start" spacing={3}>
                  ...
                  <Text fontSize="sm" color="var(--vl-color-text-secondary)">
                    {t('voicemate.benefit4Desc', 'No complicated software. No studio equipment. Just open VoiceLap, record for 30 seconds, and your VoiceTwin is ready in 60 seconds. Easier than ordering food online.')}
                  </Text>
                </VStack>
              </Box>
          ...
          {/* FAQ Section */}
          <VStack spacing={8} w="full" maxW="900px" className="vl-cid-voicemate-faq" data-cid="voicemate-faq">
            <Heading
              as="h2"
              fontSize={['xl', '2xl', '3xl']}
              color="var(--vl-color-text-primary)"
            ...
            <VStack spacing={4} w="full" align="stretch" className="vl-cid-voicemate-faq-list" data-cid="voicemate-faq-list">
              <Box
                className="vl-glass-card"
                p={5}
                borderRadius="lg"
          ...
          <VStack
            spacing={6}
            w="full"
            bg="var(--vl-gradient-cta-soft)"
            p={[8, 10, 12]}
            borderRadius="2xl"
            border="1px solid var(--vl-color-brand)"
            textAlign="center"
            className="vl-cid-voicemate-final-cta"
          ...
          >
            ...
            <Stack direction={["column", "column", "row"]} spacing={4} justify="center" w={["full", "full", "auto"]} px={[4, 6, 0]}>
              ...
              <Button
                ...
                _hover={{ bg: 'var(--vl-color-brand)', color: 'white', transform: 'translateY(-2px)' }}
                transition="all 0.3s ease"
                px={8}
                w={["full", "full", "auto"]}
              >
  ...
  return (
    <Flex
      ...
      data-cid="voicemate-root"
    >
      <VStack spacing={8} zIndex={1} maxW="900px" w="full" className="vl-cid-voicemate-auth" data-cid="voicemate-auth">
        {/* Hero Section */}
        <Box className="vl-glass-card p-8 rounded-2xl vl-cid-voicemate-auth-hero-card" data-cid="voicemate-auth-hero-card" p="20px" w="full" border="1px solid var(--vl-border-glass)" _hover={{ borderColor: 'var(--vl-color-brand)' }} bgGradient="var(--vl-gradient-cta-soft)">
          <VStack align="start" spacing={4}>
            ...
            <HStack spacing={2} align="center">
              <Icon as={FiStar} color="var(--vl-color-brand)" boxSize={4} />
              <Text fontSize="sm" color="var(--vl-color-text-muted)" fontWeight="500">
                {voices.length === 0
        ...
        {/* Tabbed Interface */}
        <Box className="vl-glass-card p-6 rounded-2xl vl-cid-voicemate-tabs" data-cid="voicemate-tabs" p="20px" w="full" border="1px solid var(--vl-border-glass)" _hover={{ borderColor: 'var(--vl-color-brand)' }}>
          <Tabs index={tabIndex} onChange={setTabIndex} variant="unstyled">
            <TabList
              ...
              className="vl-cid-voicemate-tabs-list"
              ...
              <TabPanel p={0}>
                <VStack align="stretch" spacing={6}>
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="var(--vl-color-text-secondary)" mb={4}>
                    ...
                    <Box position="relative" display="inline-block" mb={4}>
                      <Box className={isRecording ? 'animate-pulse' : ''} position="absolute" inset={0} borderRadius="full" bgGradient="var(--vl-gradient-cta)" opacity={0.6} filter="blur(16px)" />
                    ...
                    {isRecording && (
                      <Box>
                        ...
                        <Text mt={2} fontSize="sm" color="var(--vl-color-text-muted)">
                          {t('voicemate.sampleReadText', "Hi, this is me. I'm recording this short paragraph so VoiceLap can learn my unique voice...")}
                        </Text>
                      </Box>
                    )}
                    ...
                    <HStack my={4} align="center">
                      <Box flex="1" h="1px" bg="var(--vl-border-glass)" />
                      <Text fontSize="sm" color="var(--vl-color-text-muted)">{t('voicemate.or', 'or')}</Text>
                      <Box flex="1" h="1px" bg="var(--vl-border-glass)" />
                    </HStack>
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="var(--vl-color-text-secondary)" mb={3}>
                    ...
                    <Box
                      ...
                      border="1px solid var(--vl-border-glass)"
                    >
                      <Text fontSize="xs" color="var(--vl-color-text-tertiary)" mb={2} fontWeight="600">
                  ...
                  <Text fontSize="sm" color="var(--vl-color-text-muted)" textAlign="center">
                ...
                <VStack align="stretch" spacing={6}>
                    ...
                    <Box>
                      ...
                      >
                        <VStack align="start" spacing={3}>
                          ...
                          <Box mt={2}>
                            <Text fontSize="xs" fontWeight="600" color="var(--vl-color-text-tertiary)" mb={2}>
                          ...
                          <Text fontSize="xs" color="var(--vl-color-text-tertiary)" fontStyle="italic" mt={2}>
                  ...
                  {diarizationProcessing && (
                    <Box
                      ...
                      p={6}
                    >
                      <Spinner size="xl" color="var(--vl-color-brand)" mb={4} />
                      <Text color="var(--vl-color-text-primary)" fontWeight="600" fontSize="md" mb={2}>
                        {t('voicemate.multiSpeakerAnalyzing', '🔍 Analyzing speakers... This may take 2-5 minutes')}
                      </Text>
                      <Text color="var(--vl-color-text-secondary)" fontSize="sm" mb={4}>
                      ...
                      <VStack align="stretch" spacing={3}>
                        {speakers.map((speaker) => (
                          <Card
                            key={speaker.speaker}
                            border="1px solid var(--vl-border-glass)"
                            bg={selectedSpeakers.has(speaker.speaker) ? 'var(--vl-bg-glass)' : 'transparent'}
                            transition="0.2s"
                                ...
                                <HStack justify="space-between" align="start">
                                  <VStack align="start" spacing={1} flex={1}>
                                    <Input
                                      ...
                                      borderColor="var(--vl-border-glass)"
                                    />
                                    <HStack spacing={2} fontSize="xs" color="var(--vl-color-text-muted)">
        ...
        {success && (
          <Box
            className="vl-glass-card p-6 rounded-2xl"
            p="20px"
            w="full"
            border="2px solid var(--vl-color-brand)"
            bgGradient="var(--vl-gradient-cta-soft)"
            textAlign="center"
          >
            <Heading size="md" color="var(--vl-color-text-primary)">
              {t('voicemate.successModalTitle', '🎉 Shabash! Your VoiceTwin Is Ready!')}
            </Heading>
            <Text mt={2} color="var(--vl-color-text-secondary)" fontSize="md">
              {t('voicemate.successModalSubtitle', 'Your voice now lives in VoiceLap. Send messages that sound exactly like YOU!')}
            </Text>

            <VStack align="start" mt={4} spacing={2} bg="var(--vl-color-bg)" p={4} borderRadius="lg">
        ...
        {/* My Voices Section */}
        {voices.length > 0 && (
          <Box className="vl-glass-card p-6 rounded-2xl" p="20px" w="full" border="1px solid var(--vl-border-glass)" _hover={{ borderColor: 'var(--vl-color-brand)' }}>
            <VStack align="start" spacing={3} mb={6}>
              <HStack spacing={3}>
                <Icon as={FiFolder} boxSize={6} color="var(--vl-color-brand)" />
                <Heading size="md" color="var(--vl-color-text-primary)">
            ...
            {loadingVoices ? (
              <HStack justify="center" py={8}>
                <Spinner size="lg" color="var(--vl-color-brand)" />
                      ...
                      <VStack align="stretch" spacing={4}>
                        ...
                        <HStack justify="space-between" align="start">
                          <HStack spacing={2} flex={1}>
                            <Icon as={FiStar} color="var(--vl-color-brand)" boxSize={5} />
                            <Editable
                              value={voice.name}
                        ...
                        {/* Voice Metadata */}
                        <HStack spacing={3} fontSize="xs" color="var(--vl-color-text-muted)">
                          <HStack spacing={1}>
                        ...
                        <HStack spacing={2} justify="flex-end">
                          <Tooltip label={t('voicemate.playPreview', 'Play preview')} placement="top">
                            <IconButton
                              ...
                              size="sm"
                              variant="ghost"
                              color={playingVoiceId === voice.voiceId ? 'var(--vl-color-brand)' : 'var(--vl-color-text-muted)'}
                              _hover={{ color: 'var(--vl-color-brand)', bg: 'var(--vl-bg-glass)' }}
                          ...
                          <Tooltip label={t('voicemate.delete', 'Delete')} placement="top">
                            <IconButton
                              ...
                              variant="ghost"
                              color="var(--vl-color-text-muted)"
                              _hover={{ color: 'red.500', bg: 'var(--vl-bg-glass)' }}
        ...
        {/* How It Works */}
        <Box className="vl-glass-card p-6 rounded-2xl" p="20px" w="full" border="1px solid var(--vl-border-glass)" _hover={{ borderColor: 'var(--vl-color-brand)' }}>
          <Heading size="md" color="var(--vl-color-text-primary)">{t('voicemate.howTitle', 'How It Works')}</Heading>
          <SimpleGrid mt={4} columns={[1, 2]} spacing={6}>
            <Card border="1px solid var(--vl-border-glass)" transition="0.3s" _hover={{ borderColor: 'var(--vl-color-brand)' }}>
              <CardBody>
                <VStack align="start" spacing={2}>
                  <Heading size="sm" color="var(--vl-color-brand)">
